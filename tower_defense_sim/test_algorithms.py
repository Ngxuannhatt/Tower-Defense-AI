...
def run_tests():
    ...
    algorithms = ["A*", "Dijkstra", "Incremental A*", "D*", "BFS", "DFS", "Greedy Best-First", "Backtracking (DFS)", "Belief State Search", "Steepest Ascent Hill Climbing", "Expectimax", "AND-OR Search", "alpha_beta", "IDAstar", "Local_Beam_Search", "UCS", "forward_checking", "DFS_Searching_for_partially_observable_problems"]
