...
def run_tests():
    ...
    algorithms = ["A*", "Dijkstra", "Incremental A*", "D*", "BFS", "DFS", "Greedy Best-First", "Backtracking (DFS)", "Belief State Search", "Steepest Ascent Hill Climbing", "Simulated Annealing", "Expectimax", "AND-OR Search"]
